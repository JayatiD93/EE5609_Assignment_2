...
\begin{abstract}
This is a simple document explaining how to get equation of line that passes through a particular point in a particular direction.
\end{abstract}
...
Find the equation of the line that passes through (2  -1  4$)^T$ and is in the direction (1   2  -1$)^T$
...
\item The figure for the straight lines obtained in the question looks like Fig. \ref{fig:point_distance}.
The line at the direction of (1  2  -1$)^T$ is represented by $\vec{b}$ and the line  that passes through (2  -1  4$)^T$ is represented by $\vec{a}$.
\item Generating the points and the straight lines using python.\\
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{./figs/line_Eqn3.png}
